...
typedef struct
{
    ...
    double            LastAcceleration[3]; // ovr_vec3_t
    double            LastRotationRate[3]; // ovr_vec3_t
    double            LastMagneticField[3]; // ovr_vec3_t
    ...
    // Orientation goodies
    double            Q[4];    // quat_t
    double            A[3];    // ovr_vec3_t
    double            AngV[3]; // ovr_vec3_t
    float             Gain;
    float             YawMult;
	...
	double		      AngVFilterHistory[8][3]; // ovr_vec3_t
} Device;
