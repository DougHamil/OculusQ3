...
///////////////////////////////////////////////////////////////////////////////
void AccelFromBodyFrameUpdate( ovr_vec3_t result, const TrackerSensors *update, UByte sampleNumber,
...
///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
void MagFromBodyFrameUpdate(ovr_vec3_t result, const TrackerSensors *update, BOOLEAN convertHMDToSensor )
{    
...
///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
void EulerFromBodyFrameUpdate(ovr_vec3_t result, const TrackerSensors *update, UByte sampleNumber,
                                  BOOLEAN convertHMDToSensor )
{
...
void updateOrientation(Device *dev, MessageBodyFrame *msg)
{
    ...
    */
    ...
    //ovr_vec3_t    dV    = dev->AngV * msg->TimeDelta;
        ...
        (angVMagnitude < angVEpsilon))
    {
        ...
        double yUp[3]; // ovr_vec3_t
        yUp[0] = 0;
        yUp[1] = 1;
        yUp[2] = 0;
        //ovr_vec3_t yUp(0,1,0);
        double aw[3];
        quat_rotate(dev->Q, dev->A, aw);
        //ovr_vec3_t aw = dev->Q.Rotate(dev->A);
...
/////////////////////////////////////////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////////////////////////////////////////
void GetAngVFilterVal(Device *dev, ovr_vec3_t out)
{
    double temp[3];
...
BOOLEAN sampleDevice( Device *dev )
{
    ...
    else 
    {
        if ( res == 62 )
        {
            ...
            if( DecodeTracker((UByte *)buf,&sensorMsg, res) != TrackerMessage_SizeError )
            {
...
// waitusec:
// 0 - just check, no waiting
// < 0 wait until there's an event
// > 0 wait microseconds 
/////////////////////////////////////////////////////////////////////////////////////
BOOLEAN waitSampleDevice(Device *dev, SInt32 waitusec)
{
    fd_set readset;
    ...
    int result = select(dev->fd + 1, &readset, NULL, NULL, waitusec>0?&waitTime:0 );
